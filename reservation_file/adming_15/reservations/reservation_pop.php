...
<head>
	...
	<script>
		function printPage(){
			window.open("reservation_print.php?<?=$_SERVER['QUERY_STRING']?>","print_window");
		}

		function complete(){
			opener.parent.complete_sender();
			self.close();
		}
	</script>
</head>
           ...
           <!-- <div class="reservation-header-image">
            ...
            <form name="reservation_form" action="reservation_complete.php" method="POST" enctype="multipart/form-data">
                    ...
                    <tr>    
                        ...
                        <td colspan="3">
                            <div class="document-checkboxes">
                                ...
                                <div class="checkbox-item">
                                    <input type="checkbox" id="use_etc" name="usage_etc" value="1" <?if($_REQUEST['usage_etc'] == "1") echo "checked"; ?>>
                ...
                <div style="text-align:center;padding-bottom:10px;">
                    <button type="button" class="btn btn-primary" onclick="complete()">예약확인</button>
