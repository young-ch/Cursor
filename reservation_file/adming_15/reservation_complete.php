...
$facility_name = "";
$room_no_2 = isset($_POST['room_no_2']) ? $_POST['room_no_2'] : '0';
$facility_name .= $room_no_2;
$room_no_2t = isset($_POST['room_no_2t']) ? $_POST['room_no_2t'] : '';
$facility_name .= "==".$room_no_2t;
$room_no_4 = isset($_POST['room_no_4']) ? $_POST['room_no_4'] : '0';
$facility_name .= "|||".$room_no_4;
$room_no_4t = isset($_POST['room_no_4t']) ? $_POST['room_no_4t'] : '';
$facility_name .= "==".$room_no_4t;
$room_no_6 = isset($_POST['room_no_6']) ? $_POST['room_no_6'] : '0';
$facility_name .= "|||".$room_no_6;
$room_no_6t = isset($_POST['room_no_6t']) ? $_POST['room_no_6t'] : '';
$facility_name .= "==".$room_no_6t;
$room_no_8 = isset($_POST['room_no_8']) ? $_POST['room_no_8'] : '0';
$facility_name .= "|||".$room_no_8;
$room_no_8t = isset($_POST['room_no_8t']) ? $_POST['room_no_8t'] : '';
$facility_name .= "==".$room_no_8t;
$facility_name .= "///";
$lec_no_1 = isset($_POST['lec_no_1']) ? $_POST['lec_no_1'] : '0';
$facility_name .= $lec_no_1;
$lec_no_1t = isset($_POST['lec_no_1t']) ? $_POST['lec_no_1t'] : '';
$facility_name .= "==".$lec_no_1t;
$lec_no_2 = isset($_POST['lec_no_2']) ? $_POST['lec_no_2'] : '0';
$facility_name .= "|||".$lec_no_2;
$lec_no_2t = isset($_POST['lec_no_2t']) ? $_POST['lec_no_2t'] : '';
$facility_name .= "==".$lec_no_2t;
$lec_no_3 = isset($_POST['lec_no_3']) ? $_POST['lec_no_3'] : '0';
$facility_name .= "|||".$lec_no_3;
$lec_no_3t = isset($_POST['lec_no_3t']) ? $_POST['lec_no_3t'] : '';
$facility_name .= "==".$lec_no_3t;
$lec_no_4 = isset($_POST['lec_no_4']) ? $_POST['lec_no_4'] : '0';
$facility_name .= "|||".$lec_no_4;
$lec_no_4t = isset($_POST['lec_no_4t']) ? $_POST['lec_no_4t'] : '';
$facility_name .= "==".$lec_no_4t;
$facility_name .= "///";
$eat_no_1 = isset($_POST['eat_no_1']) ? $_POST['eat_no_1'] : '0';
$facility_name .= $eat_no_1;
$eat_no_1t = isset($_POST['eat_no_1t']) ? $_POST['eat_no_1t'] : '';
$facility_name .= "==".$eat_no_1t;
$eat_no_2 = isset($_POST['eat_no_2']) ? $_POST['eat_no_2'] : '0';
$facility_name .= "|||".$eat_no_2;
$eat_no_2t = isset($_POST['eat_no_2t']) ? $_POST['eat_no_2t'] : '';
$facility_name .= "==".$eat_no_2t;
$classroom_type = isset($_POST['classroom_type']) ? $_POST['classroom_type'] : '';
$facility_name .= "|||".$classroom_type;
$classroom_type_count = isset($_POST['classroom_type_count']) ? $_POST['classroom_type_count'] : '0';
$facility_name .= "==".$classroom_type_count;
$ground_not = isset($_POST['ground_not']) ? $_POST['ground_not'] : '';
